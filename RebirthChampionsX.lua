...
local Window = OrionLib:MakeWindow({Name = "(Mena Hub)  [🍀X7!] Rebirth Champions X V1.0.0", HidePremium = false, IntroEnabled = false, IntroText = "Mena hub", SaveConfig = true, ConfigFolder = "Mena Game Hub"})
